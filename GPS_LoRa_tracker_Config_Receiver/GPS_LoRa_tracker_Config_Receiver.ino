/***************************************************
GPS_LoRa_tracker_Config_Receiver.ino

E220 config program
Platform: Wemos mini ESP32

For use of ESP32, use modified LoRa_E220.h (2024.2.3)
Added "espSoftwareSerial" library
...
#include <SoftwareSerial.h> // Added "espSoftwareSerial" library

SoftwareSerial swSer(D7, D8);
LoRa_E220 e220ttl(&swSer, D3, D5, D6); // &SoftwareSerial, AUX M0 M1
// -------------------------------------
